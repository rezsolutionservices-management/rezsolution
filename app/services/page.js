        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "2rem", maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <div style={{ backgroundColor: "#F4F5F7", border: "1px solid #E5E7EB", borderRadius: "8px", padding: "2rem", display: "flex", flexDirection: "column", gap: "1rem" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <span style={{ backgroundColor: "#E5E7EB", color: "#666666", fontFamily: "Barlow Condensed, sans-serif", fontWeight: 700, fontSize: "0.9rem", padding: "4px 12px", borderRadius: "20px", whiteSpace: "nowrap" }}>
                $0 surcharge
              </span>
            </div>
            <p style={{ color: "#555555", fontSize: "0.95rem", lineHeight: 1.6 }}>
              Dedicated medical and healthcare delivery for clinics, pharmacies, and health organizations. Confidential, time-sensitive, and handled with care.
            </p>
            <div style={{ backgroundColor: "#EFF6FF", border: "1px solid #BFDBFE", borderRadius: "4px", padding: "0.75rem 1rem", color: "#1E40AF", fontSize: "0.85rem", lineHeight: 1.5 }}>
              All medical deliveries are governed by our Privacy & Confidentiality Policy and Medical Courier Services Agreement. Available upon request or through our Business Accounts page.
            </div>
          </div>
